...
export function AdminLayout({
  ...
  const menuItems: Array<{
    ...
    { id: "hotels", label: "Hospedagens", icon: <Hotel className="h-4 w-4" /> },
    { id: "restaurants", label: "Restaurantes", icon: <UtensilsCrossed className="h-4 w-4" /> },
    { id: "tours", label: "Passeios", icon: <Compass className="h-4 w-4" /> },
    { id: "events", label: "Eventos", icon: <Calendar className="h-4 w-4" /> },
    { id: "itineraries", label: "Roteiros", icon: <Map className="h-4 w-4" /> },
